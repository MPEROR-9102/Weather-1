...
class CurrentWeatherFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val forecastObserver = Observer<OneCallForecast> { oneCallForecast ->
            ...
            binding.dateTextView.text = formatDate(oneCallForecast.current.date)
            ...
            binding.sunriseTextView.text = formatTime(oneCallForecast.current.sunrise, TimeFormatType.FullTime)
            binding.sunProgressBar.progress = getSunProgress(oneCallForecast.current.sunrise, oneCallForecast.current.sunset)
            binding.sunsetTextView.text = formatTime(oneCallForecast.current.sunset, TimeFormatType.FullTime)
